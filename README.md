...
I decided to write this post because I have found that there is a lack of information on how to use SLURM to manage HPC jobs on DelftBlue and INSY clusters and some students are struggling with it. I hope that this post will help you get started with SLURM and HPC jobs on DelftBlue and INSY clusters.
...
Calm down and you can use the following command if you are not knowing what you are doing
```bash
module load 2022r2
...
```
On similar lines, you can also create a cache and local folders on the scratch storage and link to them in your home directory.
```bash
...
# Contribute 
If you find any errors or have any suggestions, please feel free to open an issue or pull request in https://github.com/Mirmix/tudelft-hpc-tutorial.
